        ...
        <div class="col-md-12 blog-main">
            ...
            <div class="kedua row">
                <div class="game1 col-md-3">
                    <img src="<?= $row["gambargame1"] ?>" alt="..." class="img-thumbnail">    
                    <p><?= $row["namagame1"] ?></p> 
                </div>   
                <div class="game1 col-md-3">
                    <img src="<?= $row["gambargame2"] ?>" alt="..." class="img-thumbnail">    
                    <p><?= $row["namagame2"] ?></p> 
                </div>
                <div class="game1 col-md-3">
                    <img src="<?= $row["gambargame3"] ?>" alt="..." class="img-thumbnail">    
                    <p><?= $row["namagame3"] ?></p> 
                </div>
                <div class="game1 col-md-3">
                    <img src="<?= $row["gambargame4"] ?>" alt="..." class="img-thumbnail">    
                    <p><?= $row["namagame4"] ?></p> 
                </div>  
            </div>
            ...
            <div class="keempat row">
                <div class="kereta1 col-md-3">
                    <img src="<?= $row["kereta1"] ?>" alt="..." class="img-thumbnail">    
                </div>   
                <div class="kereta2 col-md-3">
                    <img src="<?= $row["kereta2"] ?>" alt="..." class="img-thumbnail">     
                </div>
                <div class="kereta3 col-md-3">
                    <img src="<?= $row["kereta3"] ?>" alt="..." class="img-thumbnail">    
                </div>
                <div class="kereta4 col-md-3">
                    <img src="<?= $row["kereta4"] ?>" alt="..." class="img-thumbnail">    
                </div>  
            </div>
        </div>
    </div>
